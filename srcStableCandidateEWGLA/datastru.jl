...
mutable struct Label
    ...
    #
#    function Label(CA,nI::UInt16) # inner constructor
#        label        = new()
#        label.CA     = CA #[0,0]
#        label.listJ1 = Vector{UInt16}(undef,nI) #[]
#        return label
#    end
    #
...
mutable struct Label2
    origin :: Int64 # id of services who has generated the label
    CA     :: Tuple{Int64, Int64}   # (partiel) allocation cost 
    listJ1 :: Vector{UInt16}   # (partial) allocation of user-service !! Max 65535 users
    #
    function Label2(origin,CA,listJ1) # inner constructor
        label        = new()
        label.origin = origin
        label.CA     = CA
        label.listJ1 = listJ1
